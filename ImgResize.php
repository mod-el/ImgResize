...
class ImgResize{
	 ...
	 * @throws \Exception
	 */
	public function __construct($url, $ignore_non_existent = false){
	 ...
	 * @throws \Exception
	 */
	public function save($url, array $newSizes = []){
	 ...
	 * @return bool
	 */
	public function applyWatermark($file){
		if(!file_exists($file))
			return false;
